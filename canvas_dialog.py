...
class Ui_canvas_Dialog(QDialog, FORM_CLASS):
    ...
    def setupUi(self, iface, canvas_Dialog):
        canvas_Dialog.setObjectName("canvas_Dialog")
        canvas_Dialog.resize(545, 492)
        self.Description = QtWidgets.QLabel(canvas_Dialog)
        ...
        self.N_spinBox = QtWidgets.QDoubleSpinBox(canvas_Dialog)
        ...
        self.S_spinBox = QtWidgets.QDoubleSpinBox(canvas_Dialog)
        ...
        self.retranslateUi(canvas_Dialog)
        QtCore.QMetaObject.connectSlotsByName(canvas_Dialog)

        #self.buttonBox.accepted.connect(self.on_buttonBox_accepted)
        #self.buttonBox.rejected.connect(self.on_buttonBox_rejected)
        self.buttonBox.accepted.connect(canvas_Dialog.accept)
        self.buttonBox.rejected.connect(canvas_Dialog.reject)
        self.btn_extent.clicked.connect(self.on_btn_extent)
        self.iface=iface


    def retranslateUi(self, canvas_Dialog):
        _translate = QtCore.QCoreApplication.translate
        canvas_Dialog.setWindowTitle(_translate("canvas_Dialog", "canvas_Dialog"))
